        ...
        <div class="side-menu">
            ...
            <button onclick="switchSideMenu(false)" class="align-on-menu hamburguer">
                ...
                <div class="align-on-menu">
                    <a href="src/controller/index.php?acao=favorites">
                        <img src="src/rss/img/heart.svg" alt="favorites-menu">
                        Favoritos
                    </a>
                </div>
                <div class="align-on-menu">
                    <a href="src/controller/index.php?acao=channels">
                ...
                <div class="h-line"></div>
                <div class="align-on-menu">
                    <a href="src/controller/index.php?acao=newEpisode">
                        <img src="src/rss/img/add.svg" alt="new-episode-menu">
                        Novo Episódio
                    </a>
                </div>
                <div class="align-on-menu">
                    <a href="src/controller/index.php?acao=statistic">
                ...
                <div class="h-line"></div>
                <div class="align-on-menu">
                    <a href="src/controller/index.php?acao=account">
                ...
                <div class="align-on-menu sair">
                    <a href="src/controller/index.php?acao=sair">
